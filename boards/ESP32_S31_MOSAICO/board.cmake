...
if(NOT ESP_VISION_IDF_OVERLAY STREQUAL "release6.1")
    message(FATAL_ERROR
        "ESP32_S31_MOSAICO is supported only with ESP-IDF release/v6.1. "
...
set(ESP_VISION_BOARD_MANAGER_SETUP_SOURCES
    "${ESP_VISION_BOARD_DIR}/bmgr/board_variant.c"
    "${ESP_VISION_BOARD_DIR}/bmgr/setup_device.c"
)
list(APPEND ESP_VISION_BOARD_MANAGER_EXTRA_COMPONENTS efuse)
